                            ...
                            <div class="card-header">
                                ...
                                @if(Auth::user()->role_id == 2)
                                    <div class="card-tools">
                                        <a href="{{ route('pelatih.add') }}" class="btn btn-success btn-sm">
                                        ...
                                        <tbody>
                                            @foreach ($pelatih as $data)
                                                <tr>
                                                    ...
                                                    @if(Auth::user()->role_id == 2)
                                                        <td>
                                                            <a href="{{ route('a.pelatih.edit', $data->id) }}"> <button class="btn btn-warning btn-sm"><i class="fa fa-eye"></i></button></a>
